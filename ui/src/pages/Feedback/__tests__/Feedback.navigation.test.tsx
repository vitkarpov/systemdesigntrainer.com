...
describe('Feedback - Navigation Consistency', () => {
  beforeEach(() => {
    ...
    mockUseFeedback.mockReturnValue({
      ...
      statusInfo: { status: 'completed', feedback: mockFeedbackData, progress: 100 },
  ...
  describe('Navigation Elements', () => {
    ...
    it('should show "New Interview" button in header', () => {
      ...
      const newInterviewButtons = screen.getAllByRole('button', { name: /new interview/i })
    ...
    it('should navigate to "/" when "New Interview" button is clicked', async () => {
      ...
      const newInterviewButton = screen.getAllByRole('button', { name: /new interview/i })[0]
  ...
  describe('Error State Navigation', () => {
    it('should show "Back to Home" button in error state', () => {
      mockUseFeedback.mockReturnValue({
        feedback: null,
        statusInfo: { status: 'failed', error: 'Generation failed', progress: 0 },
        isFeedbackLoading: false,
        isStatusLoading: false,
        feedbackError: null,
        generateMutation: { isPending: false },
