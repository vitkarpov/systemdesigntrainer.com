          ...
          <div className="prose prose-sm max-w-none dark:prose-invert space-y-6">
            <section>
              ...
              <p className="text-muted-foreground">
                System Design Trainer ("we", "our", or "us") is committed to
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                    ...
                    <li>
                      <strong>Interview Content:</strong> Your responses,
                      diagrams, and other content created during interview
                      sessions
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                    <li>
                      ...
                      the Service, including interview sessions, features
                      accessed, and time spent
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Analytics Data:</strong> We use third-party
                      analytics services (such as Sentry) to monitor and analyze
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                ...
                <li>
                  Generate AI-powered feedback and insights on your interview
                  performance
                </li>
                <li>
            ...
            <section>
              ...
              <div className="space-y-2 text-muted-foreground">
                <p>
                  ...
                  analytics, email delivery, hosting services, and customer
                  service.
                </p>
                <p>
                  <strong>AI Service Providers:</strong> Your interview content
                  may be processed by AI service providers (such as OpenAI or
                  Anthropic) to generate feedback and insights. These providers
                  are contractually obligated to protect your data and use it
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                disputes, and enforce our agreements. Demo sessions that are not
                claimed may be deleted after 7 days.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground mt-2">
                ...
                <li>
                  Access controls and authentication requirements for our
                  systems
                </li>
              </ul>
              <p className="text-muted-foreground mt-2">
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2">
                ...
                channels. We will respond to your request within a reasonable
                timeframe.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                activity on our Service. Cookies are files with a small amount
                of data that are stored on your device. You can instruct your
              ...
              <div className="mt-2 space-y-2 text-muted-foreground">
                ...
                <p>
                  <strong>Demo Cookies:</strong> Used to maintain state during
                  free demo sessions
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-2">
                Our Service integrates with third-party services that may
                collect information:
              </p>
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
                <li>
                ...
                <li>
                  ...
                  monitoring (subject to Sentry's Privacy Policy)
                </li>
                <li>
                  <strong>AI Providers:</strong> For generating interview
                  content and feedback (subject to their respective privacy
                  policies)
                </li>
              </ul>
              <p className="text-muted-foreground mt-2">
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                your information to our facilities and to the third parties with
