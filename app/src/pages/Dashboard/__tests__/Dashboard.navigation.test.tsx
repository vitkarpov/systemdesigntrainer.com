...
const mockUseDashboard = useSessionsControllerGetDashboard as ReturnType<
  typeof vi.fn
>;
...
describe("Dashboard - Navigation Consistency", () => {
  ...
  describe("Session Navigation", () => {
    it('should show "View Session" button for completed sessions', () => {
      ...
      expect(
        screen.getByRole("button", { name: /view session/i }),
      ).toBeInTheDocument();
    });
    ...
    it('should show "View Feedback" button for sessions with scores', async () => {
      ...
      expect(
        screen.getByRole("button", { name: /view feedback/i }),
      ).toBeInTheDocument();
    });
